...
<style lang="less" scoped>
  ...
  .centered-image {
    ...
    max-width: 100%; /* 可选，根据需要设置图片最大宽度 */
    max-height: 100%; /* 可选，根据需要设置图片最大高度 */
  }
</style>
